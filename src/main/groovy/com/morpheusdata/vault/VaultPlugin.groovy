 ...
 * @author David Estes 
 */
class VaultPlugin extends Plugin {

	@Override
	String getCode() {
		return 'morpheus-vault-plugin'
	}

	@Override
	void initialize() {
		 VaultCredentialProvider vaultCredentialProvider = new VaultCredentialProvider(this, morpheus)
		 this.pluginProviders.put("vault", vaultCredentialProvider)
		 this.setName("Vault")
	}
